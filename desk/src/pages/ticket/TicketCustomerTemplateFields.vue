<template>
  <div class="space-y-2 px-6 py-3.5 border-b">
    ...
    <div class="flex items-center gap-4">
      <span class="w-[150px] shrink-0 text-sm text-ink-gray-5">Machine</span>
      <span
        class="flex-1 truncate rounded border border-outline-gray-2 bg-surface-white px-2 py-1 text-base font-medium"
        :class="
          ticket.data.machine ? 'text-ink-gray-9' : 'text-ink-gray-4'
        "
      >
        {{ ticket.data.machine || "—" }}
      </span>
    ...
    <div class="flex items-center gap-4">
      <span class="w-[150px] shrink-0 text-sm text-ink-gray-5">Location</span>
      <span
        class="flex-1 truncate rounded border border-outline-gray-2 bg-surface-white px-2 py-1 text-base font-medium"
        :class="
          ticket.data.location ? 'text-ink-gray-9' : 'text-ink-gray-4'
        "
      >
